...
export const ico = (name) => {
    ...
    switch (suffix) {
        ...
        case 'jpeg':
        case 'gif':
        case 'bmp': return 'icon/types/image-x-generic.svg';
        case 'svg':
        case 'xml': return 'icon/types/image-x-svg+xml.svg';
        case 'html': return 'icon/types/text-html.svg';
        case 'c++':
        case 'cpp': return 'icon/types/text-x-c++.svg';
